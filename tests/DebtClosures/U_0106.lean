...
/-! Compile-only probes at `Type 1`. Each application was rejected while the
corresponding carrier or bridge was fixed to `Type 0`. -/
...
theorem debtClosure_U_0106 : True := True.intro
