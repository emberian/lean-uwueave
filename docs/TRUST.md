...
root-level `main` declarations never enter one proof aggregate. The full gate
has **140 passing Rust tests**. This is valuable implementation evidence; it is
not an atomic-write, stable-media, path-safety, or filesystem-crash theorem.
